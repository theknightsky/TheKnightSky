...
var sideMenu = (function(){
	...
	// http://coveroverflow.com/a/11381730/989439
		...
		var domClickFn = function(e){
					if(!hasParentClass(e.target, 'main-menu')){
						// classie.remove(fullWrap, 'side-menu-open');
						fullWrap.removeClass('side-menu-open');
						$(document).off(eventtype, domClickFn);
					}
				}
			...
			button.on(eventtype, function(e){
				e.stopPropagation();
				e.preventDefault();
				fullWrap.addClass('side-menu');
				setTimeout(function(){
					fullWrap.addClass('side-menu-open');
				}, 25);
				$(document).on(eventtype, domClickFn);
			});
